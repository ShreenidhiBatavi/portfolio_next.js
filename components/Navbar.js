...
const Navbar = () => {
  ...
  return (
    <div className='menu flex lg:flex-row flex-col justify-between h-10 p-2 items-center relative'>
        ...
        {/* menu buttons */}
       {show?<div className="flex lg:bg-transparent bg-gray-600 z-10  flex-col lg:hidden lg:w-auto w-full justify-center items-center gap-y-3 p-5 mt-8 ">
                <Link  href="/">
        ...
        <div className="flex lg:bg-transparent bg-gray-600 z-10  hidden lg:flex lg:flex-row lg:w-auto w-full justify-center items-center gap-y-3 p-5 mt-8 ">
                <Link  href="/">
                    <div className="w-32 cursor-pointer hover:bg-orange-300  mx-4 flex justify-center items-center h-8 rounded shadow-xl text-gray-700 font-bold  bg-amber-500" >Home</div>
                </Link>
                <Link  href="/about">
